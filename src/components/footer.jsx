    ...
    <footer class="bg-white shadow mt-8">
        <div class="container mx-auto py-2 px-6 text-center text-gray-600 flex flex-col items-center">
            <div class="flex space-x-4">
                ...
                <a href="https://www.facebook.com/profile.php?id=61580231661206" target="_blank" aria-label="Facebook"
                ...
                <a href="https://www.instagram.com/nicholas_carrol_author/" target="_blank" aria-label="Instagram"
                    class="hover:opacity-80 transition">
                ...
                <a href="https://www.goodreads.com/user/show/193606353-nicholas-carrol" target="_blank" aria-label="Goodreads"
                    class="hover:opacity-80 transition">
