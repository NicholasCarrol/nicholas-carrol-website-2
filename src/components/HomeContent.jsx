...
export default function HomeConfig() {
    ...
    return (
        ...
        //Book Banner
        <>
            <section class="bg-gray-200 flex flex-col items-center justify-center min-h-[30vh] text-center">
                <h1 class="text-4xl md:text-6xl font-extrabold text-gray-900 mb-4">Darkness of Creation</h1>
                <p class="text-lg md:text-xl text-gray-500 font-bold mb-4">“Quillan can do infinitely more than any creator before him.
                    <span class="text-blue-900"> For good.</span> Or for <span class="text-red-700">evil.</span>”</p>
                <p class="text-md text-gray-700 mb-1">Coming October 1st 2025</p>
            </section>
            ...
            <div class="bg-gray-100 flex w-full justify-start items-start px-4 py-8 md:flex-row flex-col gap-16">
                ...
                <section class="flex-1 flex flex-col justify-center items-start min-h-[20vh] px-1 text-left md:pr-36">
                    ...
                    <p class="text-lg md:text-xl text-gray-700 mb-8">A seasoned mercenary, a sheltered princess, and an orphan
                        creator must work together stop, Quillan, the most powerful creator the world has ever seen. If only
                        each of them didn't have their own secret ties to Quillan.</p>
                    <a href="#amazonlinkgoeshere"
                        class="bg-gray-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-700 transition">Purchase
                        on
                        Amazon</a>
                </section>
            </div>
            ...
            <section class="bg-gray-100 flex flex-col items-center justify-center min-h-[20vh] text-center px-6 py-8">
                ...
                <form class="w-full max-w-md">
                    <div class="flex items-center border-b border-gray-400 py-2">
                        ...
                        <button
                            class="flex-shrink-0 bg-gray-600 text-white text-sm px-6 py-2 rounded-lg hover:bg-gray-700 transition"
                            type="submit">
                            Subscribe
                        </button>
                    </div>
