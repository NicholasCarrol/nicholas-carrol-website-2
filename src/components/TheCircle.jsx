        ...
        <section
            ...
            <section class="text-left">
                ...
                <div class="flex-1 text-lg text-gray-700 mb-4 leading-relaxed">
                    Technology in the Circle is comparable to a high-Renaissance or advanced Classical era.
                    Most cities are quite large (some even reach into the milions!) and have advanced sewage and plumbing systems, 
                    with fresh water readily available at city pumps and sewage either treated dumped far outside the city.
                    The wealthy often have access to water through pumps directly in their home.
                    <br></br><br></br>
                ...
                <div class="text-lg text-gray-700 mb-4 leading-relaxed">
                    ...
                    <div class="flex gap-6 mt-4">
                        <section class="right-4">
                            ...
                            <p>
                                Unumans are monotheists, worshiping an all-powerful god. According their religion, three beings, known as The Keepers, 
                                were created by God to create the Circle and everything in it, with the single rule that they could not make creators. 
                                The Keepers rebelled, led by Mákiél, the most devious of them, and created creators. In response, God cast 
                                The Keepers down to the world they had created.
                                For this reason, Unumans see creators as either entirely evil or their abilities as evil. 
                        ...
                        <section class="left-10">
                            ...
                            <p>
                                ...
                                the fourth being called Ishtus. The gods decided to create a world to commune with, 
